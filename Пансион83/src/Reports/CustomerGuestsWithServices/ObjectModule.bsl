...
//	|		CustomerSales.Агент,
//	|		CustomerSales.ДокОснование.Контрагент,
//	|		CustomerSales.ДокОснование.Договор,
...
//	ReportBuilder.HeaderText = NStr("EN='Контрагент guests with services';RU='Сводка по гостям от контрагентов с услугами';de='Sammelbericht nach Gästen von Vertragspartnern mit Diensten'");
//	

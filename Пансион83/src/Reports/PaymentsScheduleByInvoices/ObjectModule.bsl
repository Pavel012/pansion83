...
//	|	Invoices.СчетНаОплату.CheckDate AS CheckDate,
...
//	|	ВзаиморасчетыПоСчетам.CheckDate AS CheckDate,
...
//	|		InvoicePayments.СчетНаОплату.CheckDate,
...
//	|	ВзаиморасчетыПоСчетам.CheckDate,
...
//	|	ГруппаГостей.*,
//	|	CheckDate,
//	|	(WEEK(ВзаиморасчетыПоСчетам.CheckDate)) AS CheckDateWeek,
//	|	(MONTH(ВзаиморасчетыПоСчетам.CheckDate)) AS CheckDateMonth,
//	|	(QUARTER(ВзаиморасчетыПоСчетам.CheckDate)) AS CheckDateQuarter,
//	|	(YEAR(ВзаиморасчетыПоСчетам.CheckDate)) AS CheckDateYear,
//	|	СчетНаОплату.*,

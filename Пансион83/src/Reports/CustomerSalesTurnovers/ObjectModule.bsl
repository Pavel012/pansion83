...
//	|			SalesTurnovers.Договор AS Договор,
...
//	|			SalesForecastTurnovers.Контрагент,
//	|			SalesForecastTurnovers.Договор,
...
//	ReportBuilder.HeaderText = NStr("EN='Контрагент sales turnovers';RU='Обороты продаж по контрагентам';de='Verkaufsumsätze nach Vertragspartnern'");
//	
